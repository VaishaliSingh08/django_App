...
class Products(models.Model):
    p_id_pk = models.AutoField(primary_key=True)
...
class User(models.Model):
    ...
    user_qualification = models.CharField(max_length=50)
    password = models.CharField(max_length=50)
    cnfrm_pass = models.CharField(max_length=50)
...
class VerifyEmailLinkcounter(models.Model):
    ...
    requester = models.OneToOneField(AuthUser, models.DO_NOTHING)
